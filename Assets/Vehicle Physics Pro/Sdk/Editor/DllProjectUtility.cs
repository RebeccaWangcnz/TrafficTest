...
// WARNING! THIS SCRIPT MAY POTENTIALLY RENDER YOUR PROJECT UNUSABLE!
//
// - Ensure to have a way to revert the project back to a good state (backup or vcs).
// - Do NOT uncomment this script unless you have received specific instructions
//		and have understood them entirely.
...
public class DllProjectUtility
	...
	static string sdkPath = @"Assets\Vehicle Physics Pro\Sdk\VehiclePhysicsPro sdk-v9.4.csv";
