...
public class GearModeSelector : MonoBehaviour,
	...
	void HighlightGear (int gearMode)
		...
		bool showLowGear = gearMode > 4;
		SetGraphicEnabled(gearLow, showLowGear);

		if (showLowGear && gearLow != null)
			gearLow.text = (gearMode - 4).ToString();
		}
	...
	void ClearEngagedGearMode ()
		...
		SetGraphicEnabled(gearLow, false);
		}
	...
	void SetGraphicEnabled (Graphic graphic, bool enabled)
		{
		if (graphic != null)
